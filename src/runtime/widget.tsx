/** @jsx jsx */
import {React, AllWidgetProps, css, jsx, DataSourceComponent, defaultMessages as jimuCoreDefaultMessage  } from 'jimu-core';
...
layerDefintionUpdate = () =>{
 ...
 queryParams.maxRecordCountFactor =3;
 queryParams.num = 4000;
 queryParams.start = 1;
 ...
 if (this.state.where_clause){
   ...
   //or
   //this.state.jimuMapView.jimuLayerViews[this.state.facility_layer].view.filter = {"where":this.state.where_clause};
   ...
   return (
     <div className="widget-gpReport jimu-widget" css={style}>   
       ...
       <div><h2>
         ...
         {/* <span dangerouslySetInnerHTML={{__html: "Facilities in view: " +this.state.FACIDs.length}} /> */}
       </h2></div>    
