	...
	*/
	 ...
	 render() {
        ...
        return (
			...
			<b>Filter by aquaculture sector</b> <br/>
			<Label tabIndex={2} css={highlight}>
			...
			<b>Reported drug and pesticide deposits by year</b>
			<br></br>
			<Label tabIndex={2} css={highlight}>
...
{/* 			Species:
			...
			Facility Reference Number (Federal or Provincial):
			  <TextInput aria-label="Reference Number to search" 
			    placeholder="Federal/Provincial Authorization or B.C. Identifier" defaultValue="" size="sm" style={{width:"200px"}}
				type="text"
				value={this.state.facid}
				onChange={this.handleFacIDChange}
			/>
			Licence holder: 
			  <TextInput aria-label="Enter a business name to search"
			   placeholder="Enter business name" defaultValue="" size="sm" style={{width:"200px"}}
			   type="text"
